    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "#0A0A0A", color: "#FAF8F5" }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <img src="/brand/logo.png" alt="Las Dos Doncellas · Productos Ibéricos" className="h-56 w-auto mx-auto" draggable={false} />
          <div className="font-script gold text-lg mt-4">Panel CMS</div>
        </div>
