...
async def upload_product_image(
    ...
    final_bytes = enhanced_bytes or original_bytes
    final_content_type = "image/png" if enhanced_bytes else (file.content_type or "image/jpeg")
    ext = "png" if enhanced_bytes else ((file.filename or "img.jpg").rsplit(".", 1)[-1].lower() or "jpg")
    ...
    await db.product_images.insert_one({
        ...
        "ai_enhanced": bool(enhanced_bytes),
