...
async def on_startup():
    try:
        ...
        await db.production_slicings.create_index("created_at")
        await db.production_slicings.create_index("cliente_id")
        ...
        await db.bank_accounts.create_index("nombre")
        await db.treasury_movements.create_index([("account_id", 1), ("fecha", -1)])
        await db.treasury_movements.create_index("fecha")
        await db.issued_invoices.create_index([("status", 1), ("due_date", 1)])
